...
function initIsoTop() {
	...
	var cisotopeHolder = jQuery('#collection-container'),
		win = jQuery(window);
	jQuery('#collection-container').isotope({
		itemSelector: '.item',
		transitionDuration: '0.6s'
	});
	jQuery('.caseFilter a').click(function(e){
		e.preventDefault();
		jQuery(this).parent('li').siblings('li.active').removeClass('active');
		jQuery(this).parent('li').addClass('active');
		var selector = jQuery(this).attr('data-filter');
		cisotopeHolder.isotope({ filter: selector });
	});


	// Isotope init
	var misotopeHolder = jQuery('#masonry-container'),
		win = jQuery(window);
	...
	jQuery('.filter a').click(function(e){
		...
		jQuery(this).parent('li').addClass('active');
		var selector = jQuery(this).attr('data-filter');
		misotopeHolder.isotope({ filter: selector });
	});
}
